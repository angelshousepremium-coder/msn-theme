...
.stc-contact-breadcrumbs .rank-math-breadcrumb,
.stc-contact-breadcrumbs p {
    margin: 0;
}
.stc-contact-breadcrumbs a { color: var(--stc-contact-muted); }
.stc-contact-breadcrumbs .last { color: var(--stc-contact-ink); }
.stc-contact-hero {
    padding: 34px 0 42px;
...
.stc-contact-card {
    ...
    padding: 30px;
    box-shadow: 0 22px 74px rgba(0,0,0,.18);
    position: relative;
    overflow: hidden;
}
...
.stc-contact-section { padding: 80px 0; }
...
.stc-contact-info-panel {
    ...
    box-shadow: 0 16px 50px rgba(17,17,17,.07);
}
.stc-contact-info-panel__head {
    padding: 0 0 6px;
}
.stc-contact-info-panel__head strong {
    display: block;
    margin: 0;
    color: var(--stc-contact-ink);
    font-family: var(--font-heading, Montserrat, sans-serif);
...
.stc-contact-info-panel__head span {
    display: block;
    margin-top: 8px;
    color: var(--stc-contact-muted);
    font-size: 14px;
...
.stc-contact-info-row:first-of-type {
    padding: 18px 18px 16px;
    border: 1px solid rgba(236,98,31,.16);
    border-radius: 18px;
    background: #fff7f2;
}
...
.stc-contact-info-row:first-of-type .stc-contact-info-row__value,
.stc-contact-info-row:first-of-type .stc-contact-info-row__value p {
    font-size: 17px;
    line-height: 1.65;
    font-weight: 800;
}
.stc-contact-info-row a {
    color: var(--stc-contact-orange);
    font-weight: 800;
    text-decoration: none;
}
...
.stc-contact-phone-item {
    ...
    border: 1px solid var(--stc-contact-border);
    border-radius: 14px;
    background: var(--stc-contact-soft);
}
...
@media (max-width: 700px) {
    ...
    .stc-contact-title { font-size: clamp(30px, 11vw, 42px) !important; }
    .stc-contact-lead { font-size: 16px; }
    .stc-contact-section { padding: 52px 0; }
    ...
    .stc-contact-phone-item span { display: block; text-align: left; margin-top: 4px; }
    .stc-contact-reviews__widget,
        ...
        <div class="stc-contact-container">
            ...
            <div class="stc-contact-map-grid">
                ...
                <aside class="stc-contact-info-panel">
                    <div class="stc-contact-info-panel__head">
                        <strong>Контакты офиса</strong>
                        <span>Связь с центральным офисом в Екатеринбурге — адрес, телефоны и рабочее время.</span>
                    </div>
