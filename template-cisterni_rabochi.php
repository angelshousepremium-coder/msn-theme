...
<div class="stc-container stc-section"><div class="stc-partners stc-animate">
    <a href="https://rscural.ru/" class="stc-pcard stc-pcard--svc" rel="noopener">
        <div class="stc-pcard__bg" aria-hidden="true"><svg viewBox="0 0 560 240" fill="none" preserveAspectRatio="xMidYMid slice"><rect width="560" height="240" fill="#0f0f0f"/><circle cx="420" cy="90" r="140" stroke="#ec621f" stroke-width=".4" fill="none" opacity=".2"/><circle cx="420" cy="90" r="90" stroke="#ec621f" stroke-width=".4" fill="none" opacity=".15"/><circle cx="440" cy="100" r="32" stroke="#333" stroke-width="2.5" fill="none"/><line x1="408" y1="100" x2="472" y2="100" stroke="#333" stroke-width="2"/><line x1="440" y1="68" x2="440" y2="132" stroke="#333" stroke-width="2"/></svg></div>
        <div class="stc-pcard__content"><div class="stc-pcard__icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div>
        <h3 class="stc-pcard__title">Сертифицированные<br>сервисные центры Урал</h3>
        <ul class="stc-pcard__list"><li>Модернизации и доработки техники</li><li>Переоборудование на газ</li><li>Гарантийное обслуживание и ремонт</li></ul>
        <span class="stc-pcard__link">Подробнее →</span></div>
    </a>
    <a href="https://z.spectechcom.ru/" class="stc-pcard stc-pcard--parts" rel="noopener">
        <div class="stc-pcard__bg" aria-hidden="true"><svg viewBox="0 0 560 240" fill="none" preserveAspectRatio="xMidYMid slice"><rect width="560" height="240" fill="#071007"/><line x1="0" y1="48" x2="560" y2="48" stroke="#0f2a0f" stroke-width="10"/><line x1="0" y1="96" x2="560" y2="96" stroke="#0f2a0f" stroke-width="10"/><line x1="0" y1="144" x2="560" y2="144" stroke="#0f2a0f" stroke-width="10"/><rect x="308" y="12" width="4" height="200" rx="2" fill="#1a351a"/></svg></div>
        <div class="stc-pcard__content"><div class="stc-pcard__icon"><svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg></div>
        <h3 class="stc-pcard__title">Запчасти для автомобилей<br>Урал от официального дилера</h3>
        <ul class="stc-pcard__list"><li>Только оригинальные запчасти к а/м Урал</li><li>Более 10 000 наименований в наличии</li><li>Доставка в регионы Дальнего Востока</li></ul>
        <span class="stc-pcard__link">Подробнее →</span></div>
    </a>
</div></div>
