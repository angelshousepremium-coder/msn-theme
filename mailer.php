...
if (!empty($_POST)) {
	...
	*/
	...
	require __DIR__ . '/inc/google-api-php-client-2.2.3/vendor/autoload.php'; // google-api-php-client path

	function getClient()
	{
	    $client = new Google_Client();
	    $client->setApplicationName('SpecTech');
	    $client->setScopes(Google_Service_Sheets::SPREADSHEETS);
	    //PATH TO JSON FILE DOWNLOADED FROM GOOGLE CONSOLE FROM STEP 7
	    $client->setAuthConfig('google-api-spectech.json'); 
	...
	$spreadsheetId = '14pxH1qVSQj5dhwS5e3cbJd1NMuk107wtWIDzcNdZUbY'; // spreadsheet Id
