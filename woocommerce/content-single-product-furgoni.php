<?php
/**
 * Шаблон товара: Фургоны Урал — v4.3
 */
    ...
    <div class="stc-advantages__inner">
      ...
      <div class="stc-advantages__grid">
        ...
        <div class="stc-adv-card">
          ...
          <p class="stc-adv-card__text">Лояльность всех лизинговых компаний РФ. Аванс от 10%, одобрение за 1 день</p>
        </div>
        <div class="stc-adv-card">
  ...
  <section class="stc-cta-split">
    <div class="stc-cta-split__orange">
      <div class="stc-cta-split__content stc-animate">
        ...
        <p class="stc-cta-split__sub">Ответим в течение&nbsp;1 рабочего дня. Без навязчивых звонков.</p>
...
(function(){
  ...
  var o=new IntersectionObserver(function(e){e.forEach(function(i){if(i.isIntersecting){i.target.classList.add("stc-visible");o.unobserve(i.target);}});},{threshold:.1});
  document.querySelectorAll(".stc-animate").forEach(function(el){o.observe(el);});
})();
</script>
