...
<div class="about-feature">
          ...
          <div class="about-feature-item">
            <img src="/wp-content/uploads/2025/05/car-manufacturing.png" alt="icon">
            <p><strong>Собственное производство</strong><br>фургонов по требованию<br> или эскизу заказчика</p>
          </div>

          
          <div class="about-feature-item">
            <img src="/wp-content/uploads/2025/05/days.png" alt="icon">
            <p><strong>Изготовление фургонов</strong><br>от 7,5 тонн и от 10 дней!</p>
          </div>

          
          <div class="about-feature-item">
            <img src="/wp-content/uploads/2025/05/warranty-2.png" alt="icon">
            <p><strong>Гарантия 1 год!</strong><br>Доставка по РФ бесплатно</p>
          </div>

          
          <div class="about-feature-item">
            <img src="/wp-content/uploads/2025/05/tuning.png" alt="icon">
            <p><strong>Оформление в ГИБДД</strong><br>Доработки и дооборудование.<br>Лизинг.</p>
          </div>
