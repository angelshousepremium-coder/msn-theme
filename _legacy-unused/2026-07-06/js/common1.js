jQuery(function(a) {
        a(function() {
            ...
            a("ul.i-tab1 li").click(function() {
                var b = a(this).attr("data-tab");
                a("ul.i-tab1 li").removeClass("current"), a(".tabcontent1").removeClass("current"), a(this).addClass("current"), a("#" + b).addClass("current")
            })
        }), a(function() {
            a("ul.i-tab2 li").click(function() {
                var b = a(this).attr("data-tab");
                a("ul.i-tab2 li").removeClass("current"), a(".tabcontent2").removeClass("current"), a(this).addClass("current"), a("#" + b).addClass("current")
            })
            ...
            a(function() {
                a("#back-top a").click(function() {
                    ...
                    768 <= a(window).width() ? a("html, body").animate({
                        scrollTop: a(".block-questions").offset().top + a(".block-questions").height() + 60
                    }, 1) : a("html, body").animate({
                        scrollTop: a(".block-questions").offset().top + a(".block-questions").height() + 20
                    }, 1)
                })
            })
